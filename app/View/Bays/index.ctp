<div class="bays index">
	<h2><?php echo __('Bays'); ?></h2>
	...
	<tr>
		<td><?php echo h($bay['Bay']['id']); ?>&nbsp;</td>
		<td><?php echo h($bay['Bay']['name']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($bay['Region']['name'], array('controller' => 'regions', 'action' => 'view', $bay['Region']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $bay['Bay']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $bay['Bay']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $bay['Bay']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $bay['Bay']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
